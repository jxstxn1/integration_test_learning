...
import 'package:integration_test_learning/main.dart';

void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  testWidgets(
    "Not Inputing a text and wanting to go to the display page shows "
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.enterText(
        find.byKey(Key('TypingPage_InputField_Key')),
        inputText,
      );
